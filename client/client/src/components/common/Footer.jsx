...
const Footer = ({ className, ...props }) => {
  return (
    <footer
      className={twMerge("w-full bg-black text-white", className)}
      {...props}
    >
              ...
              <div className="w-full lg:w-[32%] flex flex-col gap-8">
                <div className="flex flex-col md:flex-row justify-between items-start gap-8">
                  ...
                  <div className="flex flex-col gap-4 w-full md:w-auto">
                    ...
                    <nav className="flex flex-col gap-4">
                      <a
                        href="#"
                        className="text-base font-normal leading-6 text-left text-white hover:opacity-80"
                      >
                        My Account
                      </a>
                      <a
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <a
                      href="#"
                      className="text-base font-normal leading-6 text-left text-white hover:opacity-80 mt-4"
                    >
                      Shop
                    </a>
                  </div>
